...
if is_museum
    ...
    H_pickup_station= eye(4); H_pickup_station(1:3,4) = [0.525, -0.475, 0.05];
    H_inspection_tunnel= eye(4); H_inspection_tunnel(1:3,4) = [0.575, 0.0, 0.05];
    H_release_station= eye(4); H_release_station(1:3,4) = [0.575, 0.45, 0.05];
